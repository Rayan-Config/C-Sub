...
```
https://raw.githubusercontent.com/Rayan-Sub/multi-proxy-config-fetcher/refs/heads/main/configs/proxy_configs.txt
```
...
### Detailed Report
📊 [View Full Interactive Dashboard](https://htmlpreview.github.io/?https://github.com/Rayan-Sub/multi-proxy-config-fetcher/blob/main/assets/performance_report.html)
